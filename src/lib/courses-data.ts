...
export const courses: TCourses = [
	{
		...
		price: [
			{
				pay: '17 000 ₽',
				description: ['Разовая консультация', '(длительность 1 час)'],
			},
			{
				pay: '150 000 ₽',
				description: [
	...
	},
	{
		...
		price: [
			...
			{
				pay: '60 000 ₽',
				description: ['Месячное сопровождение', '(4 консультации)'],
			},
			{
				pay: '150 000 ₽',
				description: [
			...
			{
				pay: '260 000 ₽',
				description: ['Полугодовое сопровождение', '(24 консультации)'],
			},
			{
				pay: '500 000 ₽',
				description: ['Годовое сопровождение', '(50 консультаций)'],
			},
		],
		note: '',
	},
