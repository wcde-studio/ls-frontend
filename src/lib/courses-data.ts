...
export const courses: TCourses = [
  {
    ...
    suitable: 'Кому подходит: всем, кто хочет прокачать свою жизнь, стать успешнее и счастливее.',
    description: [
  ...
  {
    name: 'Бизнес',
    suitable: 'Кому подходит: Для руководителей, владельцев бизнеса, начинающих бизнесменов и тех, кто только хочет открыть бизнес.',
    description: [
  ...
  },
  {
    ...
    suitable: 'Кому подходит: Для владельцев бизнеса с численностью от 5 человек, нуждающихся в эффективности команд и масштабировании бизнеса.',
    description: [
